# Scientific Report Generator: Single Prompt

Let's generate a scientific report for this project. Use the folder reports/YYYY-mm-DD-title and following structure and information.

## Structure and auxiliary info

1. Title and Abstract
2. Common Introduction, approx 6 pages
...
6. Implementation, approx 12 pages
...
7. Control of success, Acceptance criteria, approx 6 pages
   - Sources: Acceptance criteria from UserStory.md
8. Results, approx 10 pages
...
9. Summary and outlook, approx 2 pages
   - Sources: Sprint retrospective + roadmap
10. Sources: title, link, author(s), date published, when accessed by you
...
- You can use `docs/arch_vis folder` which contain the planutml code for the `assets/images`
- You can use all links in the projects, e.g., inside the README.md
